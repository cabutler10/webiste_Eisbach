...
export function EbayIcon(props) {
  return (
    <SvgIcon {...props} viewBox="0 0 302.8 120.1">
      <path
        id="e"
...
export function AmazonIcon(props) {
  return (
    <SvgIcon {...props} viewBox="-352.037 -291.281 800.073 678.559">
...
export function SurfIcon(props) {
  return (
    <SvgIcon {...props} viewBox="0 0 106.048 106.048">
      <g>
        <path
          style={{ fill: "currentColor" }}
          d="M106.048,84.188c-86.873,4.919-62.585-61.511-40.068-55.764c-2.335,1.401-3.857,6.294-2.393,9.577
...
export function FeatherIcon(props) {
  return (
    <SvgIcon {...props} viewBox="0 0 486.999 486.999">
      <g>
        <path
          d="M245.998,369.041c-36.206-9.382-82.293-37.023-122.338-85.506c65.484,49.425,102.909,74.005,186.401,79.731
